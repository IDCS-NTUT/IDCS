...
class DetectionMsg(BaseModel):
    ...
    tracker_world_pos_m: Optional[Tuple[float, float, float]] = None
    tracker_world_vel_mps: Optional[Tuple[float, float, float]] = None
    tracker_world_horizon_ms: Optional[float] = None
