...
from ._common import (
    _build_camera as _build_camera_shared,
    _vector_length,
    _normalise,
    _rotate_vector,
    _parse_orientation,
...
class CPURenderer:
    ...
    def __init__(self, *, context: Any) -> None:
        ...
        self._building_light_dir = _normalise(
    ...
    def _build_camera(self, camera_state: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        This is a wrapper around the shared _build_camera function that passes
        the renderer's width, height, and context.
        """
        return _build_camera_shared(camera_state, self.width, self.height, self._context)
