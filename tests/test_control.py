...
def _make_mpc_config_for_tests() -> MpcConfig:
    return MpcConfig(
        ...
        costs=MpcCostConfig(
            q_theta=AxisPair(1.0, 1.0),
            l_theta=AxisPair(0.0, 0.0),
            q_omega=AxisPair(0.5, 0.5),
            q_dtheta=AxisPair(0.0, 0.0),
            l_dtheta=AxisPair(0.0, 0.0),
            r=AxisPair(0.05, 0.05),
            s=AxisPair(0.05, 0.05),
            l_du=AxisPair(0.0, 0.0),
            terminal=None,
            rho=10.0,
        ),
